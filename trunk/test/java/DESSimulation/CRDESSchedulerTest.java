...
public class CRDESSchedulerTest extends TestCase {
	...
	/**
	 * Test of sendEndCommEvent method, of class CRDESScheduler.
	 */
	public void testSendEndCommEvent() {
		System.out.println("sendEndCommEvent");
		int crnode_id = 0;
		CRDESScheduler instance = null;
		instance.sendEndCommEvent(crnode_id);
		// TODO review the generated test code and remove the default call to fail.
		
	}

	/**
	 * Test of sendStartCommEvent method, of class CRDESScheduler.
	 */
	public void testSendStartCommEvent() {
		System.out.println("sendStartCommEvent");
		int crnode_id = 0;
		CRDESScheduler instance = null;
		instance.sendStartCommEvent(crnode_id);
		// TODO review the generated test code and remove the default call to fail.
